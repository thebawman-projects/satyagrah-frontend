  ...
  return (
    <div className="relative bg-cover bg-center h-96" style={{ backgroundImage: `url(${backgroundImage})` }}>
      <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-white p-4">
        ...
        <p className="mb-5 px-5 text-sm">"शिक्षा आपकी राहों को रोशन करती है, और सत्याग्रह ट्रस्ट आपके सपनों को साकार करने के लिए तैयार है। <br/> यह स्कॉलरशिप लोन नहीं है। <br/> हमारा मिशन ‘वरदान’ हर विद्यार्थी को शिक्षा का अधिकार दिलाने और उच्च शिक्षा को सुलभ बनाने के लिए समर्पित है। 
